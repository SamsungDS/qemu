...
enum NvmeRuhType {
    RUHT_INITIALLY_ISOLATED = 1,
    RUHT_PERSISTENTLY_ISOLATED = 2,
};
...
REG8(RUHA, 0x0)
    FIELD(RUHA, UNUSED_BY_NS, 0, 1)
    FIELD(RUHA, HOST_SPECIFIED, 1, 1)
    FIELD(RUHA, CTRL_SPECIFIED, 2, 1);
