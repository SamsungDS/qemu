...
static int nvme_ns_init(NvmeNamespace *ns, Error **errp)
{
    ...
    id_ns_ind->kpios = ns->kpios;
    id_ns_ind->maxkt = ns->maxkt;
...
static void nvme_ns_init_kpios(NvmeNamespace *ns) {
    if (!ns->params.kpios.enabled) {
        return;
    }
    ns->kpios = 3;
    ns->maxkt = ns->params.kpios.maxkt;
}
